<!doctype html>
    ...
    <head>
        ...
        <link href="../../../css?family=Poppins:400,500,600,700,900|Mirza:400,700&amp;subset=arabic" rel="stylesheet">
        <link href="../../../css-1?family=Allura" rel="stylesheet">
    ...
    <body>
        ...
        <div class="carousel-single">
            <img src="img/client6.jpg" alt="" class="rounded-circle">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="footer__bottom-content">
                                <p>&copy; 2019 Tejarat. All rights reserved. Created by <a href="#">AazzTech</a></p>
