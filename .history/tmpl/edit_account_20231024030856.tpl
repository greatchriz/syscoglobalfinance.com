    ...
    <div class="col-12 mb-30">
      <div class="create_wrapper mw-100">
              ...
              >
                ...
                {include file="edit_account_input.tpl" name="password" label="New Password:" type="password" disabled=""} 


                {include file="edit_account_input.tpl" name="password2" label="Retype Password:" type="password" disabled=""}
