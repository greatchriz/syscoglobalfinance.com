            ...
            <div class="tab-area">
                <div class="tab-item active">
                    <div class="faq-wrapper">
                        ...
                        <div class="faq-item">
                            <div class="faq-title">
                                <h5 class="title">I wish to invest with syscoglobalfinance.com but I don't have an any ecurrency account. What should I do?</h5>
                                <span class="right-icon"></span>
                            </div>
                            <div class="faq-content">
                                <p>
                                    You can open a free PM account here: www.perfectmoney.is
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item">
                            <div class="faq-title">
                                <h5 class="title">Which e-currencies do you accept?</h5>
                                <span class="right-icon"></span>
                            </div>
                            <div class="faq-content">
                                <p>
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-content">
                                <p>
                                    Log into your syscoglobalfinance.com account and click on the "Account Information". You can change your e-mail address and password there.
                                </p>
                            </div>
                        </div>
