    ...
    <div class="col-12 mb-30">
      <div class="create_wrapper mw-100">
              ...
              >
                ...
                {include file="edit_account_input.tpl" label="Account Name:" userinfo=$userinfo.username disabled="disabled" value="{$userinfo.username}"}

                {include file="edit_account_input.tpl" label="Registration date:" userinfo=$userinfo.date_register disabled="disabled" value="{$userinfo.date_register}"}

                {include file="edit_account_input.tpl" label="Full Name:" userinfo=$userinfo.name disabled="" value='{$userinfo.name|escape:"quotes"}'}
{* 
                <table
                  cellspacing=0
                  cellpadding=2
                      ...
                      <td>
                        ...
                        >
                          ...
                          {section name=c loop=$countries}
                            <option {if $countries[c].name eq $userinfo.country}selected{/if}>{$countries[c].name|escape:"quotes"}
                            </option>
                          {/section}
                        </select>
                      </td>
