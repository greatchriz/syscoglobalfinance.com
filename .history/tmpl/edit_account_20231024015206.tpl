    ...
    <div class="col-12 mb-30">
      <div class="create_wrapper mw-100">
              ...
              >
                ...
                {include file="edit_account_input.tpl" label="Account Name:" userinfo=$userinfo.username disabled="disabled"}

                {include file="edit_account_input.tpl" label="Registration date:" userinfo=$userinfo.date_register disabled="disabled"}

                {include file="edit_account_input.tpl" label="Full Name:" userinfo=$userinfo.name disabled=""}
{* 
                <table
                  cellspacing=0
                  cellpadding=2
