...
<html lang="en">
    ...
    <head>
        ...
        <title>Sysco Global Finance -  Investment HTML Template</title>
                ...
                <div class="dasboard-body">
                    <div class="dashboard-hero">
                                                        ...
                                                        <li>
                                                            <a href="#0">
                                                                ...
                                                                <div class="cont">
                                                                    ...
                                                                    <div class="message">Electus rem placeat
                                                                        perspiciatis saepe</div>
                                                    ...
                                                    <ul class="notification-body">
                                                        <li>
                                                            <a href="#0">
                                                                ...
                                                                <div class="cont">
                                                                    <span class="subtitle">New Affiliate
                                                                        Registered</span>
                                                                    <span class="info">2 Sec ago</span>
                                                                </div>
                                                            </a>
                                                        ...
                                                        <li>
                                                            <a href="#0">
                                                                ...
                                                                <div class="cont">
                                                                    <span class="subtitle">Fund Transfer
                                                                        Completed</span>
                                                                    <span class="info">2 Sec ago</span>
                                                                </div>
                                                            </a>
                                            ...
                                            <li>
                                                ...
                                                <div class="notification-area">
                                                    <div class="author-header">
                                                        ...
                                                        <h6 class="title">John Doe</h6>
                                                        <a href="#mailto:johndoe@gmail.com"><span
                                                                class="__cf_email__"
                                                                data-cfemail="1f557077717b707a5f78727e7673317c7072"
                                                            >[email&#160;protected]</span></a>
                                                    </div>
                        ...
                        <div class="dashboard-hero-content text-white">
                            ...
                            <ul class="breadcrumb">
                                <li>
                                    <a href="{"?a=referals"|encurl}">Home</a>
                                </li>
                                <li>
                                    Dashboard
                                </li>
                        ...
                        <div class="row pb-30">
                            ...
                            <div class="col-lg-6">
                                <div class="earn-item mb-30">
                                    ...
                                    <div
                                        class="earn-content partner-content d-flex flex-wrap align-items-start justify-content-between">
