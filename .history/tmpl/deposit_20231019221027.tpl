            ...
            <div class="deposit-item">
              ...
              >
                <div class="deposit-header">
                  <h3 class="title">{$plans[plans].plans[options].percent|string_format:"%.2f"}%</h3>
                  <span><b>R.O.I</b></span>
                </div>
                <div class="deposit-body">
                  <div class="item">
                    ...
                    <div class="item-content">
                      ...
                      <h5 class="subtitle"><span class="min">${$plans[plans].plans[options].min_deposit}</span><span
                          class="to"
                        >to</span><span class="max">${$plans[plans].plans[options].max_deposit}</span></h5>
                      </h5>
                    </div>
                  </div>
                  ...
                  <div class="item">
                    ...
                    <div class="item-content">
                      ...
                      <h5 class="subtitle">{$plans[plans].plans[options].name|escape:html}</h5>
                    </div>
                  </div>
                </div>
              </div>
