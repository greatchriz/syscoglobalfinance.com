  ...
  {else}
    ...
    >
      ...
      <div class="deposit-system">
        <h4 class="main-subtitle">02. Spend funds from the Account Balance</h4>
        <div class="text-center deposit-method-slider owl-theme owl-carousel">
          ...
          {section name=p loop=$ps}
            {if $ps[p].balance > 0 and $ps[p].status == 1}
              <a
                href="#0"
                class="deposit-method-item {if ($frm.type == $ps[p].id)} active {/if}"
              >
                <input
                  type=checkbox
                  name=type
        ...
        <h4 class="main-subtitle">03. Spend funds from External Wallet</h4>
