...
<ul class="dashboard-menu">
    ...
    <li>
        <a href="{"?a=deposit"|encurl}"><i class="flaticon-interest"></i>Deposits</a>
    </li>

    <li>
        <a href="{"?a=deposit_history"|encurl}"
        ><i class="flaticon-coin"></i>Deposit History</a>
    </li>

    <li>
        <a href="{"?a=deposit_list"|encurl}"><i class="flaticon-interest"></i>Active Investments</a>
    </li>

    <li>
        <a href="{"?a=history&type=earning"|encurl}"><i class="flaticon-interest"></i>Earnings History</a>
    </li>

    {if $settings.use_referal_program == 1}
    <li>
        <a href="{"?a=history&type=commissions"|encurl}"><i class="flaticon-interest"></i>Referrals History</a>
    </li>
    {/if}
    ...
    <li>
        <a href="{"?a=withdraw_history"|encurl}"><i class="flaticon-interest"></i>Withdraw History</a>
    </li>
